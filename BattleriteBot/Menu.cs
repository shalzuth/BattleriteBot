...
#else
                MenuWindow = GUILayout.Window(MenuId, MenuWindow, MenuMethod, "By Shalzuth " + Assembly.GetExecutingAssembly().GetName().Version, GUILayout.ExpandHeight(true));
#endif
            }
        }
